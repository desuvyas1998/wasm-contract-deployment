...
try {
  ...
  const wsProvider = new WsProvider('5GMosZeWFjiJK4HS9rrgitZq7odYDHuyqBvdzJ7HMaSButSR');
  ...
  const PHRASE = 'common velvet trap sunset typical left sugar now just gallery vanish abstract';
